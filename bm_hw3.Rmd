...
Intepretation:
First, we use F-test to test the equality of variances. The result shows that the variances of two groups are equal. Then we use t-test to test the equality of mean. The result shows that the means of BMI changes of two groups are different. So there is significant BMI changes between women who quit smoking and women who never smoked.
